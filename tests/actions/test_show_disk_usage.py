...
#     # aqui eu transformo os objetdos gerados do tipo PosixPath em strings
#     # para que a função get_printable_file_path os aceite
...
#     assert all(
#         # remove espaços em branco e verifica se a presença da saida
